// Builds the sidebar/topbar shell shared by every page after login, so
// the navigation markup exists in exactly one place. Plain JS DOM
// building - no framework/template engine.
